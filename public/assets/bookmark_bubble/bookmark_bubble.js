...
google.bookmarkbubble.Bubble.prototype.getIconUrl_ = function() {
  if (!this.iconUrl_) {
    ...
    if (!link || !(this.iconUrl_ = link.href)) {
      this.iconUrl_ = '/assets/images/icon192.png';
    }
  }
...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.style.backgroundColor = '#f4f4f4';
...
bubbleInner.innerHTML = 'このWebアプリをより一層便利に使うために、%iconを押して<strong>ホーム画面に追加</strong>ボタンを押して下さい';
} else {
/* bubbleInner.innerHTML = 'Install this web app on your phone: ' +
'tap <b style="font-size:15px">+</b> and then ' +
'<b>\'Add to Home Screen\'</b>';*/
bubbleInner.innerHTML = 'このWebアプリをより一層便利に使うために、ブラウザのオプションメニューから<strong>ホーム画面に追加</strong>を押して下さい.<small>オプションメニュ-はハードウェアボタンや右上のメニューアイコン<span class="ath-action-icon">icon</span>を押すと表示されます.</small>';
}
...
arrow.style.background = '#f4f4f4';
arrow.style.border = 'solid 1px #d7d7d7';
